...
coin_image=loadImage("images(2).png")
obstacle1=loadImage("obstacle1.png")
obstacle2=loadImage("obstacle2.png")
obstacle3=loadImage("obstacle3.png")
gameover=loadImage("download (3).jfif")
...
gameoversound=loadSound("mixkit-arcade-space-shooter-dead-notificaton-272.wav");
...
play1=createSprite(225,160,20,20);
...
text("coins:"+coin,200,20);

if(Gamestate===PLAY){;
score=score+Math.round(getFrame()/60);
